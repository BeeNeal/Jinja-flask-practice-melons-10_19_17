...
#The <melon_id> part of argument is coming from the
#jinja variable: /melon/{{ melon.melon_id }} (all_melons.html)
#This is passed as an argument to instantiate the 'melon' object with melon_id
